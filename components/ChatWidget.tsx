...
export default function ChatWidget({ markets }: Props) {
  ...
  const {
    messages, streaming, error, send, clear, stop,
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-sm font-medium text-neutral-200">
                  {showHistory ? "Chat History" : "Analysis Chat"}
                </div>
                {!showHistory && (
          ...
          {showHistory && (
            <div className="flex-1 overflow-y-auto">
              <div className="p-3">
                <button
                  onClick={handleNewChat}
                  className="w-full text-left px-3 py-2 text-sm text-blue-400 bg-blue-500/10 rounded-lg hover:bg-blue-500/20 transition-colors mb-2"
                >
                  + New chat
                </button>
                {sessions.length === 0 && (
                  ...
                  {sessions.map((session) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="text-neutral-600 hover:text-red-400 opacity-0 group-hover:opacity-100 transition-all ml-2 text-xs"
                      >
                        {"\u2715"}
                      </button>
                    </div>
